...
describe('setup author boundary', () => {
  ...
  test.each([
    ...
    ['property-order scalar name first', '{"env":[{"name":"DB_PASSWORD","value":"literal"}]}'],
    ['property-order scalar value first', '{"env":[{"value":"literal","name":"DB_PASSWORD"}]}'],
    [
      'property-order nested name first',
      '{"wrapper":[{"env":[{"name":"DB_PASSWORD","value":[{"part":"literal"}]}]}]}',
    ],
    [
      'property-order nested value first',
      '{"wrapper":[{"env":[{"value":[{"part":"literal"}],"name":"DB_PASSWORD"}]}]}',
    ],
  ...
  test.each([
    ...
    '{"env":[{"value":"${DB_PASSWORD}","name":"DB_PASSWORD"}]}',
    '{"wrapper":[{"env":[{"name":"DB_PASSWORD","value":[{"part":"${DB_PASSWORD}"}]}]}]}',
    '{"wrapper":[{"env":[{"value":[{"part":"${DB_PASSWORD}"}],"name":"DB_PASSWORD"}]}]}',
